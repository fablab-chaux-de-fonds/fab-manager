...
Translation.create(locale:'fr', key:'app.public.pages.prices.calculator_title', value:'Imprimantes 3D')
Translation.create(locale:'fr', key:'app.public.pages.prices.calculator_subtitle', value:'Ultimaker, Prusa et Leapfrog')
